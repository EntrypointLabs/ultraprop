...
|------|---------|----------------|------------|
| Sui CLI (mainnet branch) | mainnet-v1.71.1 | 2026-05-19 | https://github.com/MystenLabs/sui/releases/tag/mainnet-v1.71.1 |
| Anchor | 1.0.2 | 2026-05-19 | https://github.com/coral-xyz/anchor/releases (tag v1.0.2, published 2026-05-02) |
| Solana / Agave CLI | 4.0.0 | 2026-05-19 | https://github.com/anza-xyz/agave/releases/tag/v4.0.0 |
| Node.js LTS | 24.15.0 (Krypton — current active LTS) | 2026-05-19 | https://nodejs.org/dist/index.json (filtered `lts: true`); see https://nodejs.org/en/about/previous-releases |
| pnpm | 11.1.3 | 2026-05-19 | https://github.com/pnpm/pnpm/releases/tag/v11.1.3 |
| Rust stable | 1.95.0 | 2026-05-19 | https://github.com/rust-lang/rust/releases/tag/1.95.0 |
| Next.js | 16.2.6 | 2026-05-19 | https://github.com/vercel/next.js/releases/tag/v16.2.6 |
| Biome | 2.4.15 | 2026-05-19 | https://github.com/biomejs/biome/releases/tag/%40biomejs%2Fbiome%402.4.15 |
| Turborepo | 2.9.14 | 2026-05-19 | https://github.com/vercel/turborepo/releases/tag/v2.9.14 |
| Pyth Hermes endpoint | https://hermes.pyth.network (HTTP 200; /v2/price_feeds returns live feed catalog) | 2026-05-19 | https://docs.pyth.network/price-feeds/api-instances-and-providers/hermes |
